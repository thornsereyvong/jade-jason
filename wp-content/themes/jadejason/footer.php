					...
					<div class="footer-item__content">
					  <div class="footer__post">
						<div class="footer-post__img">
						  <img src="<?php echo get_template_directory_uri(); ?>/assets/img/photo-2.jpg" alt="...">
						</div>
					  ...
					  <div class="footer__post">
						<div class="footer-post__img">
						  <img src="<?php echo get_template_directory_uri(); ?>/assets/img/photo-3.jpg" alt="...">
						</div>
						<div class="footer-post__content">
						  <p><a href="#">Lorem ipsum dolor sit amet</a></p>
						  <time datetime="2015-01-01">2015/01/01</time>
					  ...
					  <div class="footer__post">
						<div class="footer-post__img">
						  <img src="<?php echo get_template_directory_uri(); ?>/assets/img/photo-6.jpg" alt="...">
						</div>
						<div class="footer-post__content">
						  <p><a href="#">Lorem ipsum dolor sit amet</a></p>
						  <time datetime="2015-01-01">2015/01/01</time>
			  ...
			  <div class="row">
				<div class="col-xs-12 col-sm-6">
				  <div class="footer__copyright">
					Copyright 2015 <a href="#">Zobenz Team</a>. All Rights Reserved.
				  </div>
				</div>
				<div class="col-xs-12 col-sm-6">
